...
Notable rule: gdUnit4 v5.x works with Godot 4.3 and 4.4, while v6.x requires Godot 4.5 or later. GodotMaker selects the right row automatically based on the Godot version you have installed.
